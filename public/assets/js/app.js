...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (window.location.search.includes('p=devices') || window.location.search.includes('p=dashboard')) {
        startAutoRefresh();
    }
});
...
async function updatePageData() {
    try {
        ...
        if (window.location.search.includes('p=dashboard')) {
            updateDashboardData(newDoc);
        } else if (window.location.search.includes('p=devices')) {
